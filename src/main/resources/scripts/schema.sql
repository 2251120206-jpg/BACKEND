...
// Note: Tạo bảng assets trong MySQL để lưu thông tin asset do Designer upload.
CREATE TABLE IF NOT EXISTS assets (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(100) NOT NULL,
    description TEXT,
    type VARCHAR(50) NOT NULL, // Note: Loại asset: CHARACTER_SVG, BACKGROUND_SVG, SOUND_MP3,...
    price DECIMAL(10, 2) NOT NULL DEFAULT 0.00, // Note: Giá, 0 nếu free
    file_url VARCHAR(255) NOT NULL, // Note: Đường dẫn file
...
// Note: Tạo bảng purchases để lưu lịch sử mua asset của Developer.
